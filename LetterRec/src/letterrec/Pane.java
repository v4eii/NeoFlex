...
public class Pane extends JPanel {
    ...
    /**
     * «акрашивает €чейки по мере перемешени€ курсора
     * @param cellPane текуша€ €чейка над которой курсор
     */ 
    ...
    /**
     * ќпредел€ет над какой €чейкой находитс€ курсор
     *
     * @param e —обытие, на действие мыши
     * @return ячейка над которой находитс€ курсор
     */
    private CellPane getClickedPane(MouseEvent e) {
        // »з коорднат мышки вычетаем рассто€ни€ до первой €чейки
        int x = e.getX() - cellPanes[0][0].getX();
        int y = e.getY() - cellPanes[0][0].getY();

        // ѕровер€ем, что курсор находитс€ в рабочей области
